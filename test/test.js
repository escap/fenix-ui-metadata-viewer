...
var pathProjectRoot = "../../../";
var projectRoot = "./";
var submoduleRoot = '../../submodules/fenix-ui-metadata-viewer/';
...
require([
    ...
    "commonPaths",
    "metadataViewerPaths"
], function (Compiler, Common, MetadataViewer ) {
    ...
    Compiler.resolve([commonConfig, metadataViewerConfig],
        {
    ...
    require([
        ...
        log.warn("~~~~~ FENIX Metadata viewer: test");
